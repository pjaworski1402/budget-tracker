        ...
        >
          ...
          >
            ...
            >
              ...
              <p className="text-purple-200">Zaloguj się do swojego konta</p>
            </motion.div>
            ...
            >
              <p className="text-sm text-purple-200">
                Nie masz konta?{' '}
                <Link href="/auth/register" className="font-semibold text-white hover:text-purple-300 transition-colors">
                  Zarejestruj się
                </Link>
              </p>
            </motion.div>
